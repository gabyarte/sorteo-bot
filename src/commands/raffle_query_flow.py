...
from src.utils.emojis import PARTY, PENSIVE, WINK, DANGER
...
def unblock_handler(user_id, query):
    User.documents.update({'telegram_id': user_id}, {'$set': {'is_blocked': False}})
...
raffle_callback_query_handler = CallbackQueryHandler(callback_query_handler)
